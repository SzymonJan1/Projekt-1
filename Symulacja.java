...
public class Symulacja {
    ...
    static int birthCount = 0, deathCount = 0; //narodzin potrzebny do tworzenia nazw kolejnych obiektow, licznik narodzin, licznik smierci
    ...
    void addAgents() {
        ...
        for (int i = 0; i < initialSmoki; i++) {
            ...
            agents.add(new Smoki(nazwa, 0, pozycjaX, pozycjaY, 5));
        ...
        for (int i = 0; i < initialLudzie; i++) {
            ...
            agents.add(new Ludzie(nazwa, 0, pozycjaX, pozycjaY, 2));
            map[pozycjaX][pozycjaY] = nazwa;
            birthCount++;
        }
        ...
        for (int i = 0; i < initialKosmici; i++) {
            ...
            agents.add(new Kosmici(nazwa, 0, pozycjaX, pozycjaY, 0));
            map[pozycjaX][pozycjaY] = nazwa;
            birthCount++;
        }
        //generowanie wrozek
        ...
        for (int i = 0; i < initialWrozki; i++) {
            ...
            agents.add(new Wrozki(nazwa, 0, pozycjaX, pozycjaY, 0));
            map[pozycjaX][pozycjaY] = nazwa;
            birthCount++;
        }
        //generowanie roslin
        ...
        for (int i = 0; i < initialRosliny; i++) {
            ...
            agents.add(new MiesozerneRosliny(nazwa, 0, pozycjaX, pozycjaY, 2));
            map[pozycjaX][pozycjaY] = nazwa;
            birthCount++;
        }
    }
