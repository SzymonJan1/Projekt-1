...
public class Ludzie extends Agent {
    ...
    public Ludzie(String name, int iteration, int positionX, int positionY, int health) {
        ...
        if (Symulacja.map[wayX][wayY].isEmpty()) { //na wybranej pozycji nie ma innego agenta
            ...
            switch (Symulacja.map[wayX][wayY].charAt(0)) {
                case 'k':
                    ...
                    Symulacja.agents.add(new Kosmici(nazwa, Symulacja.iteration, positionX, positionY, 0));
                ...
                case 'l':
                    ...
                    Symulacja.agents.add(new Ludzie(nazwa, Symulacja.iteration, pozycjaX, pozycjaY, 2));
